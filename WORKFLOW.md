...
Follow the below steps to create a new provider, using Plesk as an example:
...
8. In the provision workbench UI (typically http://127.0.0.1:9000) create a Plesk provision configuration
9. Now you can run provision functions (also known as provision requests) via the workbench UI as you develop them
10. When complete, submit your fork as a pull request (PR) back to the `main` branch on [this repository](https://github.com/upmind-automation/provision-provider-shared-hosting)
